...
When the jog dial is not moving, the pendant sends no reports. While the emergency stop switch is active, reports continue at the minimum interval.
...
This application sends the following commands to CNCjs:
